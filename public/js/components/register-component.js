        ...
        return <div className="back">
            ...
            <div className="register_body">
                <div className="form-inline">
                    ...
                    <div className="register_input">
                        <input type="text" className="form-control input_size" id="register_re_password"
                               placeholder="确认密码"/>
                    </div>
                    ...
                    <div className="register_input">
                        <input type="text" className="form-control input_size btn btn-info" id="login_password"
                               value="注册" onClick={this.register.bind(this)}/>
                    </div>
